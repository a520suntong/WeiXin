    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.weixin_bottom:
                Intent intent1 = new Intent(FoundActivity.this, MainActivity.class);
            ...
            case R.id.tongxinlu_bottom:
                Intent intent2 = new Intent(FoundActivity.this, ConnectList.class);
            ...
            case R.id.wo_bottom:
                Intent intent4 = new Intent(FoundActivity.this, MeActivity.class);
                ...
                break;
            case R.id.sousuo:
                Toast.makeText(FoundActivity.this, "搜索", Toast.LENGTH_SHORT).show();
                break;
            case R.id.more:
                Toast.makeText(FoundActivity.this, "更多", Toast.LENGTH_SHORT).show();
                break;
            default:
                break;
        }
